...
import type { SGCloseDetail } from "./modal";

let drawerId = 0;

export class SGDrawer extends HTMLElement {
    static observedAttributes = ["open", "label", "dismissible", "side", "size"];
    ...
    private syncState(): void {
        this.titleNode!.textContent = this.getAttribute("label") || "Drawer";
...
export function defineSGDrawer(): void {
    defineElement("sg-drawer", SGDrawer);
}
