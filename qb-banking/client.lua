...
my_webui:RegisterEventHandler('withdraw', function(data)
    TriggerCallback('withdraw', function(status)
        my_webui:SendEvent('bankActionResult', status)
    end, data)
end)

my_webui:RegisterEventHandler('deposit', function(data)
    TriggerCallback('deposit', function(status)
        my_webui:SendEvent('bankActionResult', status)
    end, data)
end)

my_webui:RegisterEventHandler('internalTransfer', function(data)
    TriggerCallback('internalTransfer', function(status)
        my_webui:SendEvent('bankActionResult', status)
    end, data)
end)

my_webui:RegisterEventHandler('externalTransfer', function(data)
    TriggerCallback('externalTransfer', function(status)
        my_webui:SendEvent('bankActionResult', status)
    end, data)
end)

my_webui:RegisterEventHandler('orderCard', function(data)
    TriggerCallback('orderCard', function(status)
        my_webui:SendEvent('bankActionResult', status)
    end, data)
end)

my_webui:RegisterEventHandler('openAccount', function(data)
    TriggerCallback('openAccount', function(status)
        my_webui:SendEvent('bankActionResult', status)
    end, data)
end)

my_webui:RegisterEventHandler('renameAccount', function(data)
    TriggerCallback('renameAccount', function(status)
        my_webui:SendEvent('bankActionResult', status)
    end, data)
end)

my_webui:RegisterEventHandler('deleteAccount', function(data)
    TriggerCallback('deleteAccount', function(status)
        my_webui:SendEvent('bankActionResult', status)
    end, data)
end)

my_webui:RegisterEventHandler('addUser', function(data)
    TriggerCallback('addUser', function(status)
        my_webui:SendEvent('bankActionResult', status)
    end, data)
end)

my_webui:RegisterEventHandler('removeUser', function(data)
