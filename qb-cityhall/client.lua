...
for i = 1, #Config.Cityhalls do
    ...
    for j = 1, #spots do
        local spot = spots[j]
        exports['qb-target']:AddMeshTarget('cityhall_' .. i .. '_' .. j, spot.coords, Rotator(0, spot.heading, 0), '/QBCoreAssets/Meshes/SM_Clipboard.SM_Clipboard', { collision = CollisionType.Normal, stationary = true, distance = 1000 }, {
            {
                icon = 'landmark',
