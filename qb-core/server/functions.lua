...
function QBCore.Functions.CreateFingerId()
    return string.format('FP-%s-%s-%s', GenerateId(3, 'mixed'), GenerateId(4, 'mixed'), GenerateId(4, 'mixed'))
end

function QBCore.Functions.CreateSerialNumber()
    return string.format('SN-%s-%s-%s', os.date('%Y'), GenerateId(4, 'string'):upper(), GenerateId(4, 'number'))
end

function QBCore.Functions.CreateApartmentId()
    return string.format('%s-%s%s', GenerateId(4, 'number'), GenerateId(3, 'number'), GenerateId(1, 'string'))
end

function QBCore.Functions.GeneratePlate()
    return string.format('%s%s%s', GenerateId(1, 'number'), GenerateId(3, 'string'), GenerateId(3, 'number'))
end
